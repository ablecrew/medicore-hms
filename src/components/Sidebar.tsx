...
export default function Sidebar({
  ...
  const links: LinkItem[] = [
    ...
    { name: "Admissions", path: "/admissions", icon: UserPlus, roles: ["admin", "doctor"] },
    ...
    { name: "Notifications", path: "/notifications", icon: BellIcon, roles: ["admin", "doctor", "reception", "lab", "pharmacy"] },
  ...
  return (
    <>
      ...
      {/* ────────── Sidebar panel ────────── */}
      {/* On desktop (md+) it is always visible and static.
          On mobile it slides in/out via framer-motion. */}
      <motion.aside
        ...
        `}
        /* md:static + md:translate-x-0 ensures desktop always shows it;
           the motion variants only run on mobile because md: overrides them. */
          ...
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <p className="text-lg font-extrabold leading-none tracking-tight text-slate-900">
                Medi
                <span className="bg-gradient-to-r from-[#1E88E5] to-[#2ECC71] bg-clip-text text-transparent">
                  Core
                </span>
              </p>
